...
function getjsonsuccess(a) {
    ...
    a.status;
    "" == a.thum && (a.thum = IMG_URL_DEFAULT), 
    view_thum = a.thum ? a.thum : IMG_URL_DEFAULT;
    var b = a.thum ? a.thum : IMG_URL_DEFAULT,
        c = a.thum ? a.thum : IMG_URL_DEFAULT,
        d = a.content;
    initweixin({
...
makapage.prototype["delete"] = function() {}, makapage.prototype.get = function() {
    ...
    this.element.removeClass(this.show), this.element.removeClass("floating"), "noeffect" != this.show && this.elementout.css({
        opacity: 0
    }), this.timeout && clearTimeout(this.timeout), this.looptimeout && clearTimeout(this.looptimeout), this.iscrop = !1, delete_call = null, upkey_call = null, downkey_call = null, leftkey_call = null, rightkey_call = null
