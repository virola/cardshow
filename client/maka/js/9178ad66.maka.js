...
function getjsonsuccess(a) {
    viewer_pubdata = JSON.parse(a.pubdata), a.data.json && (a.data.pdata = JSON.parse(a.data.json));
    a.status;
    "http://resource.maka.im/get?img=id/undefined/crop/NaNxNaNaNaNaNaN" == a.thum && (a.thum = "http://create.maka.im/images/maka-default.jpg"), view_thum = a.thum ? a.thum : "http://create.maka.im/images/maka-default.jpg";
    var b = a.thum ? a.thum.replace("http://resource.maka.im/get?img=id/", "http://7sbsoj.com2.z0.glb.qiniucdn.com/maka/app/gfile/public/pic%3Fget=id/") : "http://create.maka.im/images/maka-default.jpg",
        c = a.thum ? a.thum.replace("http://resource.maka.im/get?img=id/", "http://7sbsoj.com2.z0.glb.qiniucdn.com/maka/app/gfile/public/index.php/picture/get%3Fget=id/") : "http://create.maka.im/images/maka-default.jpg",
        d = a.content;
    initweixin({
    ...
    editor_makacard.musicsrc && "http://m.maka.mobi/maka/app/gfile/public/music/getcdn?get=id/" != editor_makacard.musicsrc ? ($("#musiccontroloff").hide(), $("#musiccontrolon").show(), f.loop = !0, f.autoplay = !0, f.src = editor_makacard.musicsrc, f.play(), $("body").on("touchstart", function() {
...
var project_get_url = "http://create.maka.im/admin/event/ajax_get_data",
    home_url = "../",
    url = window.document.location.href.toString(),
    get_version_url = "../admin/event/ajax_get_version",
    get_json_url = "../json/",
    re = /\w{8}/,
    _pid_ = url.match(re)[0].substr(0, 8),
    report_url = "../ext/report/ajax_fresh?id=" + _pid_,
    system_call = !1,
    delete_call, delete_lock = !1,
    upkey_call, downkey_call, leftkey_call, rightkey_call;
makapreloader.prototype.chooseroad = function() {
    ...
    a.chooseroad(), this.endnum > this.queue.length && (this.endnum = this.queue.length - 1), this.adding = setInterval(function() {
        console.log(a.curnum + "/" + a.endnum), 0 == a.endnum && (a.curnum++, a.endnum++), a.adding_i / 360 > a.curnum / a.endnum || (parseInt(100 * a.curnum / a.endnum) - a.adding_i / 3.6 > 10 ? a.adding_i += 5 : a.adding_i++, a.adding_i >= 360 ? ($("#persent").html("100%"), clearInterval(a.preloadtiming), $(".pie2").css({
            rotate: "0deg"
        }).show(), a.loadend()) : 0 == a.endnum ? ($("#persent").html("100%"), $(".pie2").css({
            rotate: "0deg"
        }).show(), clearInterval(a.preloadtiming)) : (a.adding_i <= 180 ? ($(".pie1").css({
            rotate: a.adding_i + "deg"
        }).show(), $(".pie2").css({
            background: "white"
        }).show()) : a.adding_i > 180 && a.adding_i <= 360 && ($(".pie1").css({
            rotate: "180deg"
        }).show(), $(".pie2").css({
            background: "rgba(175,228,221,1)"
        }), $(".pie2").css({
            rotate: a.adding_i + "deg"
        }).show()), $("#persent").html(parseInt(a.adding_i / 3.6) + "%")))
    }, 25), this.loadone(0)
    ...
    clearInterval(this.ifcdn), clearInterval(this.adding), clearInterval(this.preloadtiming), setTimeout(function() {
        $("#preloadarea").fadeOut(), editor_makacard.start(0), editor_makacard.initswipeaction()
    }, 500)
};
var cubedown = ["pt-page-rotateCubeTopOut", "pt-page-rotateCubeTopIn", "pt-page-rotateCubeBottomOut", "pt-page-rotateCubeBottomIn", "swipedown", "swipeup"],
    cubeup = ["pt-page-rotateCubeBottomOut", "pt-page-rotateCubeBottomIn", "pt-page-rotateCubeTopOut", "pt-page-rotateCubeTopIn", "swipeup", "swipedown"],
    cubeleft = ["pt-page-rotateCubeLeftOut", "pt-page-rotateCubeLeftIn", "pt-page-rotateCubeRightOut", "pt-page-rotateCubeRightIn", "swiperight", "swipeleft"],
    cuberight = ["pt-page-rotateCubeRightOut", "pt-page-rotateCubeRightIn", "pt-page-rotateCubeLeftOut", "pt-page-rotateCubeLeftIn", "swipeleft", "swiperight"],
    flipup = ["pt-page-flipOutTop", "pt-page-flipInBottom pt-page-delay500", "pt-page-flipOutBottom ", "pt-page-flipInTop pt-page-delay500", "swipedown", "swipeup"],
    moveup = ["pt-page-moveToTop", "pt-page-moveFromBottom", "pt-page-moveToBottom", "pt-page-moveFromTop", "swipedown", "swipeup"],
    pushup = ["pt-page-rotatePushTop", "pt-page-moveFromBottom pt-page-delay100", "pt-page-rotatePushBottom", "pt-page-moveFromTop pt-page-delay100", "swipedown", "swipeup"],
    news = ["pt-page-rotateOutNewspaper", "pt-page-rotateInNewspaper pt-page-delay500", "pt-page-rotateOutNewspaper", "pt-page-rotateInNewspaper pt-page-delay500", "swipedown", "swipeup"],
    scaleup = ["pt-page-scaleDown", "pt-page-scaleUpDown pt-page-delay300", "pt-page-scaleDownUp", "pt-page-scaleUp pt-page-delay300", "swipedown", "swipeup"],
    roomup = ["pt-page-rotateRoomTopOut pt-page-ontop", "pt-page-rotateRoomTopIn", "pt-page-rotateRoomBottomOut pt-page-ontop", "pt-page-rotateRoomBottomIn", "swipedown", "swipeup"],
    carouup = ["pt-page-rotateCarouselTopOut pt-page-ontop", "pt-page-rotateCarouselTopIn", "pt-page-rotateCarouselBottomOut pt-page-ontop", "pt-page-rotateCarouselBottomIn", "swipedown", "swipeup"],
    fall = ["pt-page-rotateFall pt-page-ontop", "pt-page-scaleUp", "pt-page-scaleDown", "pt-page-moveFromBottom", "swipeup", "swipedown"],
...
makacard.prototype.init = function(a) {
    ...
    for (var b in viewer_version_data.wemedia_link_list) {
        var d = $('<div class="tjxm" link="' + viewer_version_data.wemedia_link_list[b].link + '"></div>'),
            e = $('<img class="tjthum" src="' + viewer_version_data.wemedia_link_list[b].thumurl + '"/>'),
            f = $(' <div class="tjtitle">' + viewer_version_data.wemedia_link_list[b].title + "</div>");
        d.on("click", function() {
    ...
    var b = a[0],
        c = a[1];
    if (b != c)
        if (c == this.current && (c == this.pages.length - 1 ? this.current-- : this.current++), 0 != c ? this.pages[c].page.after(this.pages[b].page) : this.pages[c].page.before(this.pages[b].page), c > b) {
            var d = this.pages.slice(0, b),
                e = this.pages.slice(b + 1, c + 1),
                f = this.pages.slice(c + 1, this.pages.length),
                g = d.concat(e.concat(this.pages[b]), f);
            this.pages = g
        } else {
            var d = this.pages.slice(0, c),
                e = this.pages.slice(c, b),
                f = this.pages.slice(b + 1, this.pages.length),
                g = d.concat(this.pages[b]).concat(e, f);
            this.pages = g
        }
};
var pagelock = !0;
makacard.prototype.initswipeaction = function() {
    ...
    if (this.pages[a] && (this.pages[a].page.show(), this.pages[a].showeffect(), this.current = a, 0 == editor_editingmode))
        for (var b in this.pages) this.pages[b].loadelespic(b)
}, makacard.prototype.nextpage = function() {
    if (this.current == this.pages.length - 1) return viewer_version_data.specialevent && 1 == viewer_version_data.specialevent.status ? ($("#sppageframe").attr("src") || $("#sppageframe").attr({
        src: viewer_version_data.specialevent.url
    }), void $("#sppage").css({
        y: "100%"
    }).show().transition({
        y: "0%"
    })) : void("wemedia" == viewer_version_data.vip && ($("#wemediaad").show().transition({
        y: "-100%"
    }), $("#wemediaad").unbind(), $("#wemediaad").on("swipedown", function() {
        $("#wemediaad").transition({
            y: "0%"
        })
    })));
    ...
    if (console.log("prev" + this.current), 0 != this.current) {
        ...
        var a = this.pages[this.current].page,
            b = this.pages[this.current - 1].page,
            c = b.attr("effect");
        if (c) var d = effects[c][3],
            e = effects[c][2];
        else var d = null,
            e = null;
        a.removeClass(), a.addClass("page " + e), $(".pageactive").removeClass("pageactive"), setTimeout(function() {
            a.hide()
        }, 500), b.removeClass(), b.addClass("page active " + d).css({
            opacity: 1
...
var op = 0;
makapage.prototype["delete"] = function() {}, makapage.prototype.get = function() {
    return this.page
    ...
    this.pagebgimg.css({
        ...
        rotate: this.rotate
    }), editor_makacard && editor_makacard.update()
    ...
    if (this.element = $('<div class="element" style="z-index:0;border-radius:' + c + "px;top:" + this.top + "px;left:" + this.left + "px;width:" + this.width + "px;height:" + this.height + "px;background:" + this.bgcolor + '" ></div>'), 0 != this.shape && this.shapearea.css({
        ...
        "box-shadow": "1px 1px " + this.boxshadow + "px rgb(40,40,40)"
    }), this.element.css({
        overflow: "hidden"
    }), this.element.css({
        ...
        height: "auto"
    }), this.fontbold = a.ftbold ? a.ftbold : !1, this.fontcolor = a.ftcolor ? a.ftcolor : "black", this.fontitalic = a.itc ? a.itc : !1, this.fontsize = a.ftsize ? a.ftsize : "20px", this.udl = a.udl ? a.udl : !1, this.lineheight = a.lineheight ? a.lineheight : 2, this.textalign = a.textalign ? a.textalign : "none", this.textvalign = a.textvalign ? a.textvalign : "top", this.prepara = a.prepara ? a.prepara : "0", this.afterpara = a.afterpara ? a.afterpara : "0", this.contentarea && (this.fontbold && this.contentarea.css({
        "font-weight": "bold"
    }), this.fontitalic && this.contentarea.css({
        "font-style": "italic"
    }), this.udl && this.contentarea.css({
        "text-decoration": "underline"
    })), this.contentarea = $('<div  style="color:' + this.fontcolor + ";padding-right:" + this.afterpara + "px padding-left:" + this.prepara + "px;width:" + (this.width - this.afterpara - this.prepara) + 'px;height:100%;;background:rgba(0,0,0,0);word-wrap: break-word; word-break: normal;">' + this.con + "</div>"), this.contentarea.css({
    ...
    this.element.removeClass(this.show), this.element.removeClass("floating"), "noeffect" != this.show && this.elementout.css({
        opacity: 0
    }), this.timeout && clearTimeout(this.timeout), this.looptimeout && clearTimeout(this.looptimeout), this.iscrop = !1, delete_call = null, upkey_call = null, downkey_call = null, leftkey_call = null, rightkey_call = null, console.log("clean")
    ...
    this.elementout.css({
        "transform-origin": parseInt(this.left) + parseInt(this.width / 2) + "px " + a + "px"
    });
    var b = this.width < this.height ? this.width : this.height,
        c = this.borderradius / 200 * b;
    this.element.css({
        "border-radius": c + "px"
    }), this.elementout.css({
        rotate: this.rotate
        ...
        background: this.bgcolor
    }), this.resizer && this.resizer.updatecontroylayer();
    for (var d in this.toolcallback) this.toolcallback[d].call(this);
    if ("text" == this.eletype || "btn" == this.eletype)
        if (this.contentarea.css({
            "padding-left": this.prepara
        }), this.contentarea.css({
            "padding-right": this.afterpara
        }), this.contentarea.css({
            "text-align": this.textalign
        }), this.contentarea.css({
            "line-height": this.lineheight
        }), "top" == this.textvalign) this.contentarea.css({
            "margin-top": 0
        });
        else if ("middle" == this.textvalign) {
    ...
    "noeffect" == this.show && this.element.show(), this.element.css({
        ...
        "-webkit-animation-duration": this.speed / 1e3 + "s"
    });
    var a = this;
    this.timeout && clearTimeout(this.timeout), this.timeout = setTimeout(function() {
        a.elementout.css({
            opacity: a.opacity
        }), a.contentarea.addClass(a.shapeeffect), a.framearea && a.framearea.addClass(a.shapeeffect), a.element.hide().addClass(a.show).show()
    }, a.delay)
}, makaajax.prototype.jsonp = function(a) {
    var b = this;
    $.ajax({
        type: "get",
        url: get_json_url + this.pid + viewer_version + ".json",
        dataType: "json",
        cache: !0,
        success: function(a) {
...
var editor_makaproject, editor_makacard, editor_makatoolbar, editor_editingmode = 0,
    editor_preview = !1,
    preload_loadingprequeue = 0,
    viewer_version, viewer_version_data, virus_array = new Object,
    viewer_pubdata = new Object,
    viewer_preloader = new makapreloader;
...
$(window).resize(function() {}), pshape.prototype.generate = function() {
    ...
    this.element = $('<div class="element" style="z-index:1;top:' + this.top + "px;left:" + this.left + "px;width:" + this.width + "px;height:" + this.height + 'px;" ></div>'), this.shapearea = $('<div class="shapearea" style="z-index:0;position:absolute;width:100%;height:100%;overflow:hidden;background:' + this.shapecolor + '"></div>'), 0 != this.shape && this.shapearea.css({
        "-webkit-mask-box-image": "url(./plugin/shape/" + this.shape + ")  0 0 0 0 stretch stretch"
    ...
    this.shapearea.css({
        ...
        height: this.height
    }), 0 != this.shape ? this.shapearea.css({
        "border-radius": "0px"
    }) : (this.shapearea.css({
        "border-radius": this.borderradius + "px"
    }), this.shapearea.css({
        "-webkit-mask-image": ""
    })), this.resizer && this.resizer.updatecontroylayer(), this.page.update()
    ...
    setTimeout(function() {
        a.elementout.css({
            opacity: a.opacity
        }), a.element.show().addClass(a.show)
    }, 10)
}, pshape.prototype.resettodefault = function() {
    1 != this.isme && (this.contentarea.css({
        cursor: "move"
    }), this.istext = !1, $(".onedit").removeClass("onedit"))
    ...
    this.element = $('<div class="element" style="z-index:0;border-radius:' + c + "px;top:" + this.top + "px;left:" + this.left + "px;width:" + this.width + "px;height:auto;background:" + this.bgcolor + '" ></div>'), this.borderstyle = a["border-style"] ? a["border-style"] : "none", this.bordercolor = a["border-color"] ? a["border-color"] : "black", this.borderwidth = a["border-width"] ? a["border-width"] : "0px", this.element.css({
        border: this.borderstyle + " " + this.borderwidth + "px " + this.bordercolor
    }), this.rotate = a.rotate ? a.rotate : 0, this.fontsize = a.ftsize ? a.ftsize : "20px", this.udl = a.udl ? a.udl : !1, this.fontbold = a.fontbold ? a.fontbold : !1, this.fontitalic = a.fontitalic ? a.fontitalic : !1, this.fontcolor = a.ftcolor ? a.ftcolor : "white", this.lineheight = a.lineheight ? a.lineheight : 2, this.textalign = a.textalign ? a.textalign : "none", this.textvalign = a.textvalign ? a.textvalign : "top", this.prepara = a.prepara ? a.prepara : "0", this.afterpara = a.afterpara ? a.afterpara : "0", this.contentarea = $('<div contenteditable="false" style="overflow-y:hidden;width:' + (this.width - this.prepara - this.afterpara) + 'px;word-wrap: break-word;border:none;overflow:hidden;background:rgba(0,0,0,0);border:1px;line-height:100%;">' + this.con + "</div>"), this.contentarea.css({
        "margin-left": this.prepara + "px"
    }), this.contentarea.css({
        "margin-right": this.afterpara + "px"
    }), this.contentarea.css({
        "text-align": this.textalign
    }), a.version >= 21 && this.contentarea.addClass("no-margin"), this.fontbold && this.contentarea.css({
        "font-weight": "bold"
    }), this.fontitalic && this.contentarea.css({
        "font-style": "italic"
    }), this.udl && this.contentarea.css({
        ...
        "line-height": this.lineheight
    }), this.element.append(this.contentarea), this.elementout.append(this.element);
    ...
    if (1 != editor_editingmode && "btn" == this.eletype) {
        ...
        b.get().css({
            "z-index": 999
        }), b.get().on("click", function() {
            var a = encodeURIComponent("http://" + b.url);
            window.location.href = "http://create.maka.im/mobile/urlredirect.php?url=" + a
        })
    }
    ...
    this.elementout.css({
        "transform-origin": parseInt(this.left) + parseInt(this.width / 2) + "px " + b + "px"
    });
    var c = this.width < this.height ? this.width : this.height,
        d = this.borderradius / 200 * c;
    return this.element.css({
        "border-radius": d + "px"
    }), this.elementout.css({
        rotate: this.rotate
    }), this.contentarea.html(this.con), "self" == a && this.element.css({
        top: this.top
    }), this.element.css({
        left: this.left
    }), this.element.css({
        width: this.width
    }), this.contentarea.css(1 == this.fontbold ? {
        "font-weight": 700
    } : {
        "font-weight": "normal"
    }), this.contentarea.css(1 == this.fontitalic ? {
        "font-style": "italic"
    } : {
        "font-style": "normal"
    }), this.contentarea.css(1 == this.udl ? {
        "text-decoration": "underline"
    } : {
        ...
        "margin-left": this.prepara
    }), this.contentarea.css({
        width: this.width - this.prepara - this.afterpara
    }), this.resizer && this.resizer.updatecontroylayer(), this.element.css({
        border: this.borderstyle + " " + this.borderwidth + "px " + this.bordercolor
    }), this.element.css({
        background: this.bgcolor
    }), void this.element.css({
        "box-shadow": "1px 1px " + this.boxshadow + "px rgb(40,40,40)"
    })
    ...
    "noeffect" == this.show && this.element.show(), this.element.css({
        "animation-duration": parseInt(this.speed) / 1e3 + "s"
    }), this.element.css({
        "-webkit-animation-duration": parseInt(this.speed) / 1e3 + "s"
    });
    var a = this,
        b = parseInt(a.delay);
    console.log("delay" + b), this.timeout = setTimeout(function() {
    ...
    var a = this,
        b = a.element,
        c = (this.sc, this.page);
    this.istext = !0, a.isediting = !1, this.contentarea.attr({
        contenteditable: !0
    }), this.contentarea.css({
        cursor: "text"
    ...
    this.shapearea.css({
        ...
        left: this.inleft
    }), this.boxshadow && this.element.css({
        "box-shadow": "1px 1px " + this.boxshadow + "px rgb(40,40,40)"
    });
    var b = this.width < this.height ? this.width : this.height,
        c = this.borderradius / 200 * b;
    ...
    for (var f in this.qlist) {
        var g = $('<div style="width:98%;height:70px;margin-bottom:' + e + 'px;;overflow:hidden;"></div>'),
            h = $("<input pos=" + f + ' style="border:0;display:block;text-indent:10px;width:98%;outline:none;;height:60px;line-height:60px;font-size:25px;" name="' + this.qlist[f].id + '"placeholder="' + this.qlist[f].name + '"></input>');
        g.css({
            border: "solid 2px " + this.formcolor
        }), g.append(h), this.element.append(g), c.inputarray.push(h), h.on("focus", function() {
            b.element.css({
                y: -100 * $(this).attr("pos") + "px"
            })
        }), h.on("blur", function() {
            b.element.css({
                y: "0px"
    ...
    this.btnname = a.btn_name ? a.btn_name : "提交", this.btn = $('<div style="text-align:center;margin-top:30px;font-size:50px;color:white;margin-bottom:10px;width:100%;height:80px;line-height:80px;font-size:30px;background:' + this.formcolor + '" >' + this.btnname + "</div>"), this.btn.on("click", function() {
        ...
        var e = /^\d*$/,
            f = $('<img style="width:140px;position:absolute;left:50%;top:30%;margin-left:-70px;" src="plugin/sending.gif"/>'),
            g = $('<p style="margin:0;width:80%;position:absolute;top:50%;left:10%;text-align:center;color:white;font-size:40px;">提交中...</p>');
        c.inputarray[0].val() ? e.test(c.inputarray[1].val()) && c.inputarray[1].val() ? (a.formid = _pid_ + "_" + c.formid, d.append(f), d.append(g), $.ajax({
            type: "post",
            url: "http://create.maka.im/ext/api/ajax_event_form",
            dataType: "html",
            cache: !1,
            data: a,
            success: function() {
                g.html("提交成功!<br>" + c.sucmsg), f.attr("src", "plugin/sendsucess.png"), d.css({
...
}, eleform.prototype.loadpic = function() {}, eleform.prototype.viewmodeinit = function() {}, eleform.prototype.update = function() {}, eleform.prototype.get = function() {
    return this.elementout
...
makaswiper.prototype.init = function(a) {
    ...
    for (var b in this.slides) {
        {
            var c = $('<div class="swiper-slide"></div> '),
                d = this.slides[b];
            d.eles
        }
        for (var e in d) {
            var f = d[e];
            if ("pic" == f.eletype) {
                var g = $('<div style="overflow:hidden;position:absolute;top:' + f.top + "px;left:" + f.left + "px;width:" + f.width + "px;height:" + f.height + 'px"></div>'),
                    h = $('<img style="position:absolute;top:' + f.intop + "px;left:" + f.inleft + "px;width:" + f.inw + 'px;" src="http://7sbsoj.com2.z0.glb.qiniucdn.com/maka/app/gfile/public/pic%3Fget=id/' + f.picid + '/thumb/100"/>');
...
}, elechart.prototype.loadpic = function() {}, elechart.prototype.viewmodeinit = function() {}, elechart.prototype.update = function() {}, elechart.prototype.get = function() {
    return this.elementout
    ...
    var a = this,
        b = a.content,
        c = (this.element.highcharts(), a.chartdata);
    a.element.highcharts({
        ...
        yAxis: {
            ...
            min: a.min,
            title: {
                text: b.options.yAxis.title.text,
                fontSize: "18px",
                style: {
                    color: a.tcolor
                }
    ...
    this.cli = a, this.chartlegends.find(".chartlegend").removeClass("active"), this.chartlegends.find(".chartlegend").css({
        color: this.tcolor
    }), this.chartlegends.find(".chartlegend").eq(a).addClass("active");
    var b = this,
        c = (b.content, this.element.highcharts()),
        d = b.chartdata;
    this.templist = new Array;
    for (var e in d) c.series[e].hide();
    c.series[a].show(), this.clean(), this.showallcdata()
}, elechart.prototype.showeffectpreview = function() {}, elechart.prototype.resettodefault = function() {}, elechart.prototype.clean = function() {
    this.swipewarn.hide();
    var a = this;
    ...
    if (this.opacity = 1, this.elementout = $('<div class="elementout" style="background:' + this.background + ";position:absolute;z-index:0;top:" + this.top + "px;left:" + this.left + "px;width:" + this.width + "px;height:" + this.height + 'px"></div>'), this.pietitle = $('<div   style="text-align:center;position:absolute;z-index:0;top:0px;left:0px;width:' + this.width + 'px;"></div>'), this.swipewarn = $('<img style="z-index:99;position:absolute;width:180px;left:230px;top:50%;margin-top:-90px" src="plugin/swipewarn.png" />'), this.elementout.append(this.swipewarn), this.piedata.length > 1 ? (this.element = $('<div class="element"  style="z-index:0;top:50px;left:0px;width:' + this.width + "px;height:" + (this.height - 50) + 'px;"></div>'), this.elementout.append(this.pietitle)) : this.element = $('<div class="element"  style="z-index:0;top:0px;left:0px;width:' + this.width + "px;height:" + (this.height - 50) + 'px;"></div>'), this.elementout.append(this.element), this.piedata.length > 1) {
        for (var d in this.piedata) {
            var e = this.piedata[d].name,
                f = $('<span class="chartlegend" >' + e + "</span>");
...
}, elechartpie.prototype.loadpic = function() {}, elechartpie.prototype.viewmodeinit = function() {}, elechartpie.prototype.update = function() {}, elechartpie.prototype.get = function() {
    return this.elementout
    ...
    if (this.piedata[a]) {
        this.cli = a, this.pietitle.find(".chartlegend").removeClass("active"), this.pietitle.find(".chartlegend").css({
            color: this.tcolor
        }), this.pietitle.find(".chartlegend").eq(a).addClass("active");
        var b = this.width,
            c = new Object;
...
}, elechartpie.prototype.changecdata = function() {}, elechartpie.prototype.showeffectpreview = function() {}, elechartpie.prototype.resettodefault = function() {}, elechartpie.prototype.clean = function() {
    this.swipewarn.hide();
    var a = this;
    a.element.highcharts() && a.element.highcharts().destroy()
}, elechartpie.prototype.unsethammer = function() {}, elechartpie.prototype.focusedit = function() {}, elechartpie.prototype.onfocus = function() {}, elechartpie.prototype.sethammer = function() {};